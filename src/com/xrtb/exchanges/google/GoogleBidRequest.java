...
public class GoogleBidRequest extends BidRequest {
	...
	transient private OpenRtb.BidRequest internal;
	 ...
	 */
	@JsonIgnore
	public OpenRtb.BidRequest getInternal() {
		return internal;
	}
	...
	public GoogleBidRequest(InputStream in) throws Exception {
    	...
    	internal = OpenRtb.BidRequest.parseFrom(data, registry);
	 ...
	 */
	public GoogleBidRequest(OpenRtb.BidRequest br) throws Exception {
		internal = br;
		doInternal();
	}
	...
	public static GoogleBidRequest fromRTBFile(String initialFile) throws Exception {
		...
		OpenRtb.BidRequest r = reader.readBidRequest(targetStream);
